...
Consider a six-item scale composed by three pairs of antonym items scored ina 5-point likert scale. Let $i = 1, 2, 3$ be items phrased on the positive pole, and $i = a,b,c$ be the negative ones and $x_{ij}$ be the original response of subject $j$ on item $i$. The aquiescence index $acq_j$ of a subject $j$ is given by:  
