...
$$\frac{1}{6} \left[\sum_{i=1}^{3}x_{ij} + \sum_{i=a}^{c} \left( 6-x_{ij} \right) \right]$$  
$$\frac{1}{6} \left[  \sum _{i=1}^{3}x_{ij}- \sum _{i=a}^{c}x_{ij} \right]$$  

$$\frac{1}{6} \sum_{i=1}^{3}x_{ij} + \frac{1}{6} \sum_{i=a}^{c} \left(6-x_{ij} \right)$$  
$$\frac{1}{6}\sum_{i=1}^{3}x_{ij} - \frac{1}{6}\sum_{i=a}^{c}x_{ij}$$  

$$\frac{1}{6} \sum_{i=1}^{3}x_{ij} + \frac{1}{6} \sum_{i=a}^{c}x_{ij} + 3$$

$$\frac{1}{6}\sum _{i=1}^{3}x_{ij} - \frac{1}{6}\sum_{i=a}^{c}x_{ij}$$  
